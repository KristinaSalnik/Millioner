    ...
    <body>
        ...
        <h2>Меню</h2>
            <ul>
                ...
                <li>
                    <a href="/lab4/" target="_blank" >Лабораторная 4</a>
                </li>
                <li>
                    <a href="/lab5/" target="_blank" >Лабораторная 5</a>
                </li>
                <li>
                    <a href="/lab6/" target="_blank" >Лабораторная 6</a>
                </li>
                <li>
                    <a href="/lab7/" target="_blank" >Лабораторная 7</a>
                </li>
                <li>
                    <a href="/lab8/" target="_blank" >Лабораторная 8</a>
                </li>
                <li>
                    <a href="/lab9/" target="_blank" >Лабораторная 9</a>
                </li>
            </ul>
